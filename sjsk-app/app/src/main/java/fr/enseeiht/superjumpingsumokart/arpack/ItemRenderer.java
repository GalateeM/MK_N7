...
public final class ItemRenderer extends ARRenderer {
    ...
    public boolean configureARScene() {
        ...
        SYMBOLS_HASH_MAP.put(DetectionTask.Symbol.A, ARToolKit.getInstance().addModel2("Data/models/boule3.obj", "single;Data/patt.a;80", DetectionTask.Symbol.A.ordinal(), 1.0f, false));
